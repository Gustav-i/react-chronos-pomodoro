        ...
        <GenericHtml>
          ...
          <div className={styles.about_wrapper}>
            ...
            <p>
              ...
              trabalho em blocos de tempo intercalados com pausas. O objetivo é manter o foco total por um período curto e
          ...
          <div className={styles.about_wrapper}>
            <h2>
              <span className={styles.green}>⏱</span> Mas no <strong>Chronos Pomodoro</strong> tem um diferencial
            </h2>
            <p>
            ...
            <h3><span className={styles.green}>⚙️</span> Personalização do tempo</h3>
            <p>
              Você pode configurar o tempo de foco, descanso curto e descanso
              longo do jeito que quiser! Basta acessar a{' '} <RouterLink href='/settings/'>página de configurações</RouterLink> e
              ajustar os minutos como preferir.
            </p>
            <h3>🔄 Ciclos organizados em sequência</h3>
            <p>
              A cada ciclo completado, uma nova tarefa é adicionada automaticamente
